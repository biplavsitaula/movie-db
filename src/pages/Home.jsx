...
function Home() {
    ...
    const { data, loading, error } = useMovies({ search: queryParam, page: pageParam });
    ...
    return (
        <div className='container mx-auto p-4'>
            ...
            {!loading && data?.data?.movies && data?.data?.movies?.length === 0 && <p className='text-center'>No movies found</p>}
